...
예를 들어 6개의 포도주 잔이 있고, 각각의 잔에 순서대로 6, 10, 13, 9, 8, 1 만큼의 포도주가 들어 있을 때, 첫 번째, 두 번째, 네 번째, 다섯 번째 포도주 잔을
...
# i 번째 줄에서 최대 포도주 양을 결정하기 위해 비교해야 하는 경우의 수는 아래의 3가지 이다.
# i-2 최대 포도주 + i 포도주, i-3 최대 포도주 + i-1, i 포도주, i-1 최대 포도주
# i 번째 최대 포도주 양을 리스트에 저장하면, 마지막 성분의 값이 정답이 된다.
